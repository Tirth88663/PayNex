...
export const getAccount = async ({ appwriteItemId }: getAccountProps) => {
  try {
    ...
    if (!appwriteItemId) {
      console.log("No appwriteItemId provided");
      return null;
    }
console.log("appwriteItemId : ", appwriteItemId);   
    ...
    if (!bank || !bank.accessToken) {
      console.log("No bank found or invalid bank data");
      return null;
    }
    ...
    console.log("accountsResponse from plaid : ", accountsResponse);
    console.log("accountData from plaid : ", accountsResponse.data.accounts[0]);
    const accountData = accountsResponse.data.accounts[0];
...
console.log("institution from plaid : ", institution);  
